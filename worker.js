...
const REGIONS = {
  ...
  "수성못": {
    ...
    demolition:
      "트렌드 변화가 빠른 감성 상권으로, 콘셉트 교체에 따른 인테리어·원상복구 수요가 잦은 지역입니다.",
    nearby: ["들안길", "범어동", "황금동"],
  },
  ...
  "들안길": {
    ...
    demolition:
      "대형 외식 매장 교체가 발생하는 상권으로, 인테리어 시공과 원상복구 수요가 이어지는 지역입니다.",
    nearby: ["수성못", "상동", "두산동"],
  },
  ...
  "동대구역": {
    ...
    demolition:
      "역세권 개발과 상가 정비가 진행되는 상권으로, 인테리어·원상복구 수요가 꾸준한 지역입니다.",
  ...
  "앞산": {
    ...
    demolition:
      "콘셉트 매장 교체가 잦은 카페 상권으로, 소규모 인테리어 시공과 원상복구 수요가 꾸준한 지역입니다.",
    nearby: ["대명동", "봉덕동", "안지랑"],
  },
  ...
  "상무지구": {
    ...
    demolition:
      "업무지구 점포 교체가 잦은 상권으로, 인테리어 시공과 원상복구 수요가 꾸준히 발생하는 지역입니다.",
    nearby: ["치평동", "화정동", "농성동"],
  },
  ...
  "하남지구": {
    ...
    demolition:
      "산단 배후 주거상권으로, 점포 교체에 따른 인테리어 시공과 원상복구 수요가 함께 발생하는 지역입니다.",
    nearby: ["수완지구", "장덕동", "흑석동"],
  },
  ...
  "은행동": {
    ...
    demolition:
      "오래된 상가가 많은 번화가로, 노후 점포 리모델링과 원상복구 수요가 이어지는 상권입니다.",
    nearby: ["대흥동", "선화동", "중앙로"],
  },
  ...
  "봉명동": {
    ...
    demolition:
      "트렌드 변화가 빠른 유흥 상권으로, 콘셉트 교체에 따른 인테리어·원상복구 수요가 잦은 지역입니다.",
    nearby: ["궁동", "어은동", "구암동"],
  },
  ...
  "테크노밸리": {
    ...
    demolition:
      "기업 입주와 신축 상가가 이어지는 상권으로, 신규 인테리어 시공과 원상복구 수요가 함께 발생하는 지역입니다.",
    nearby: ["관평동", "송강동", "신성동"],
  },
  ...
  "성안길": {
    ...
    demolition:
      "구도심 점포 교체와 노후 상가 리모델링이 잦아, 인테리어 철거와 원상복구 수요가 꾸준한 상권입니다.",
    nearby: ["서문시장", "상당로", "북문로"],
  },
  "지웰시티": {
    slug: "gwell",
    ...
    demolition:
      "신규 상가 입점과 매장 리뉴얼이 활발해, 인테리어 철거와 원상복구 수요가 꾸준히 발생하는 상권입니다.",
    nearby: ["복대동", "가경동", "강서동"],
  },
  "청주대": {
    slug: "cju",
    ...
    demolition:
      "학기마다 점포 교체가 잦은 대학가로, 인테리어 철거와 원상복구 수요가 꾸준한 상권입니다.",
    nearby: ["사창동", "충북대", "개신동"],
  },
  "오송": {
    slug: "osong",
    ...
    demolition:
      "신도시 상가 입점과 단지 입주가 이어져, 신규 인테리어와 원상복구 수요가 함께 발생하는 상권입니다.",
  ...
  "오창": {
    ...
    demolition:
      "신도시 개발과 상가 입점이 이어져, 신규 인테리어와 점포 정비 수요가 함께 발생하는 상권입니다.",
  ...
  "충주": {
    ...
    demolition:
      "구도심 점포 교체와 신상권 입점이 함께 일어나, 철거·원상복구 수요가 이어지는 상권입니다.",
    nearby: ["성서동", "연수동", "호암지구"],
  },
  "제천": {
    slug: "jecheon",
  ...
  "충북혁신도시": {
    ...
    demolition:
      "신규 상가 입점과 단지 입주가 빠르게 이어져, 신규 인테리어와 원상복구 수요가 함께 발생하는 상권입니다.",
  ...
  "진천": {
    ...
    demolition:
      "읍내 구도심 점포 교체와 인근 신도시 개발이 함께 진행돼, 철거·원상복구 수요가 발생하는 상권입니다.",
    nearby: ["진천읍", "읍내리", "성석동"],
  },
  "옥천": {
    slug: "okcheon",
    ...
    demolition:
      "구도심 점포 교체와 노후 상가 정비가 이어져, 철거·원상복구 수요가 발생하는 상권입니다.",
    nearby: ["옥천읍", "옥천역", "금구리"],
  },
  "춘천": {
    slug: "chuncheon",
  ...
  "구미": {
    ...
    demolition:
      "구도심 점포 교체와 신시가지 입점이 함께 일어나, 철거·원상복구 수요가 이어지는 상권입니다.",
    nearby: ["원평동", "인동", "구미역"],
  },
  "경주": {
    slug: "gyeongju",
    ...
    demolition:
      "관광 상권 확장과 점포 교체가 잦아, 인테리어 철거와 원상복구 수요가 꾸준한 상권입니다.",
  ...
  "김천": {
    ...
    demolition:
      "혁신도시 상가 입점과 단지 입주가 빠르게 이어져, 신규 인테리어와 원상복구 수요가 함께 발생하는 상권입니다.",
  ...
  "경산": {
    ...
    demolition:
      "대학가 점포 교체와 택지 상가 입점이 함께 일어나, 철거·원상복구 수요가 이어지는 상권입니다.",
    nearby: ["영남대", "중앙동", "정평"],
  },
  "영주": {
    slug: "yeongju",
  ...
  "신시가지": {
    ...
    demolition:
      "신도심 점포 입점과 업종 교체가 이어져, 철거·원상복구 수요가 발생하는 상권입니다.",
  ...
  "익산": {
    ...
    demolition:
      "구도심 점포 교체와 신도심 입점이 함께 일어나, 철거·원상복구 수요가 이어지는 상권입니다.",
    nearby: ["영등동", "익산역", "원광대"],
  },
  ...
  "군산": {
    ...
    demolition:
      "구도심 노포 교체와 신상권 입점이 함께 일어나, 철거·원상복구 수요가 이어지는 상권입니다.",
  ...
  "완주": {
    ...
    demolition:
      "신도심 입점과 점포 교체가 함께 일어나, 철거·원상복구 수요가 이어지는 상권입니다.",
  ...
  "여수": {
    ...
    demolition:
      "관광 상권 확장과 신도심 점포 교체가 함께 일어나, 철거·원상복구 수요가 이어지는 상권입니다.",
    nearby: ["학동", "엑스포", "돌산"],
  },
  ...
  "목포": {
    ...
    demolition:
      "원도심 공동화와 신도심 입점이 맞물려, 철거·원상복구 수요가 이어지는 상권입니다.",
    nearby: ["하당", "평화광장", "목포역"],
  },
  ...
  "광양": {
    ...
    demolition:
      "산업 배후 신상권 입점과 구도심 점포 교체가 함께 일어나, 철거·원상복구 수요가 이어지는 상권입니다.",
    nearby: ["중마동", "광양읍", "광양항"],
  },
  ...
  "나주": {
    ...
    demolition:
      "혁신도시 점포 교체와 원도심 정비가 이어져, 철거·원상복구 수요가 발생하는 상권입니다.",
  ...
  "무안": {
    ...
    demolition:
      "신도심 입점과 구도심 점포 교체가 함께 일어나, 철거·원상복구 수요가 이어지는 상권입니다.",
